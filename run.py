...
def execute_preprocess(path=None, force=False):
...
def parse_command_line():
    ...
    parser.add_argument('-preprocess', metavar='PREPROCESS_PATH', type=str, default=None, help='Chemin pour preprocess (optionnel)')
